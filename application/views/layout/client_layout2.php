...
<?php endif; ?>
    ...
    <footer class="footer">
      <div class="container">
        <p class="text-muted">Copyright <!-- <a href="https://www.patchesoft.com/">Patchesoft</a> --> 2018. - <a href="<?php echo site_url("client/change_language") ?>"><?php echo lang("ctn_171") ?></a></p>
      </div>
    </footer>
